...
export const DoctorDashboard: React.FC<DoctorDashboardProps> = ({
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#f4f7fb] text-slate-800 font-sans flex flex-col selection:bg-emerald-500 selection:text-white">
      ...
      <div className="max-w-[1700px] mx-auto w-full flex-1 flex p-3 sm:p-4 gap-4 items-start overflow-hidden">
        ...
        <aside className={`${sidebarOpen ? 'w-56' : 'w-16'} shrink-0 transition-all duration-200 space-y-3 sticky top-16 h-[calc(100vh-4rem)] max-h-[calc(100vh-4rem)] overflow-hidden flex flex-col`}>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-2 shadow-2xs shrink-0">
            <button
              onClick={onLogout}
        ...
        <main className="flex-1 space-y-6 min-w-0 overflow-y-auto h-full pr-1">
